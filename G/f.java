...
public final class f implements ActionMode.Callback {
    ...
    public f(ActionMode.Callback actionMode$Callback0, TextView textView0) {
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode0, Menu menu0) {
        ...
        if(context0 instanceof Activity) {
            for(Object object0: packageManager0.queryIntentActivities(new Intent().setAction("android.intent.action.PROCESS_TEXT").setType("text/plain"), 0)) {
                ...
                if("com.spears.civilopedia".equals(resolveInfo0.activityInfo.packageName) || resolveInfo0.activityInfo.exported && (resolveInfo0.activityInfo.permission == null || context0.checkSelfPermission(resolveInfo0.activityInfo.permission) == 0)) {
