...
public final class n implements a {
    ...
    public n(l l0, int v, int v1, int v2, int v3, CharSequence charSequence0, int v4) {
        this.i = 0x1000;
        this.k = 0x1000;
        this.m = 0;
        this.s = null;
    ...
    public final Drawable d(Drawable drawable0) {
        if(drawable0 != null && this.w && (this.u || this.v)) {
            drawable0 = w.B(drawable0).mutate();
            if(this.u) {
    ...
    public final boolean expandActionView() {
        ...
        return this.B == null || this.B.onMenuItemActionExpand(this) ? this.n.f(this) : false;
    }
    ...
    public final Drawable getIcon() {
        ...
        int v = this.m;
        if(v != 0) {
            Drawable drawable1 = g.b.c(this.n.a, v);
            this.m = 0;
            this.l = drawable1;
    ...
    public final boolean isVisible() {
        return this.A == null || !this.A.a.overridesItemVisibility() ? (this.x & 8) == 0 : (this.x & 8) == 0 && this.A.a.isVisible();
    }
    ...
    public final MenuItem setChecked(boolean z) {
        ...
        if((v & 4) != 0) {
            ...
            for(int v3 = 0; v3 < v2; ++v3) {
                ...
                if(n0.b == this.b && (n0.x & 4) != 0 && n0.isCheckable()) {
                    int v4 = n0.x;
                    int v5 = (n0 == this ? 0 : 2) | v4 & -3;
                    n0.x = v5;
                    if(v4 != v5) {
                        n0.n.p(false);
                    }
    ...
    public final MenuItem setTitle(CharSequence charSequence0) {
        ...
        D d0 = this.o;
        if(d0 != null) {
            d0.setHeaderTitle(charSequence0);
        }
        return this;
    }
