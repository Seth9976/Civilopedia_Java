...
public final class s extends q implements MenuItem {
    public final a c;
    public Method d;

    public s(Context context0, a a0) {
        super(context0);
        if(a0 == null) {
    ...
    public final ActionProvider getActionProvider() {
        o o0 = this.c.a();
        return o0 instanceof o ? o0.a : null;
    }

    @Override  // android.view.MenuItem
    public final View getActionView() {
        View view0 = this.c.getActionView();
        return view0 instanceof p ? ((View)((p)view0).i) : view0;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider0) {
        o o0 = new o(this, actionProvider0);
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener menuItem$OnActionExpandListener0) {
        k.q q0 = menuItem$OnActionExpandListener0 == null ? null : new k.q(this, menuItem$OnActionExpandListener0);
        this.c.setOnActionExpandListener(q0);
        return this;
    }

    @Override  // android.view.MenuItem
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener menuItem$OnMenuItemClickListener0) {
        r r0 = menuItem$OnMenuItemClickListener0 == null ? null : new r(this, menuItem$OnMenuItemClickListener0);
