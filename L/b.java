...
public final class b extends Drawable {
    ...
    public final void draw(Canvas canvas0) {
        ...
        if(actionBarContainer0.o) {
            Drawable drawable0 = actionBarContainer0.n;
            if(drawable0 != null) {
                drawable0.draw(canvas0);
            }
        }
        else {
            Drawable drawable1 = actionBarContainer0.l;
            if(drawable1 != null) {
                drawable1.draw(canvas0);
            }
            Drawable drawable2 = actionBarContainer0.m;
            if(drawable2 != null && actionBarContainer0.p) {
