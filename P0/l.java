...
public final class l extends s {
        ...
        if(object0 instanceof s && (this.a == ((l)(((s)object0))).a && this.b == ((l)(((s)object0))).b && this.c.equals(((l)(((s)object0))).c))) {
            ...
            if(integer1 != null) {
                ...
                label_9:
                    ...
                    String s1 = this.e;
                    if(s1 == null) {
                        return s == null ? this.f.equals(((l)(((s)object0))).f) && w.i.equals(w.i) : false;
                    }
                    return s1.equals(s) ? this.f.equals(((l)(((s)object0))).f) && w.i.equals(w.i) : false;
                }
            }
    ...
    public final int hashCode() {
        ...
        return w.i.hashCode() ^ (((v ^ v2) * 1000003 ^ v1) * 1000003 ^ this.f.hashCode()) * 1000003;
    }

    @Override
    public final String toString() {
        return "LogRequest{requestTimeMs=" + this.a + ", requestUptimeMs=" + this.b + ", clientInfo=" + this.c + ", logSource=" + this.d + ", logSourceName=" + this.e + ", logEvents=" + this.f + ", qosTier=" + w.i + "}";
    }
}
