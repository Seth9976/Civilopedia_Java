...
public final class c extends b {
    ...
    public final void a(AccessibleObject accessibleObject0) {
        ...
        try {
            ...
            throw new JsonIOException("Gson couldn\'t modify fields for " + accessibleObject0 + "\nand sun.misc.Unsafe not found.\nEither write a custom type adapter, or make fields accessible, or include sun.misc.Unsafe.", securityException0);  // 初始化器: Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
        }
    }
}
