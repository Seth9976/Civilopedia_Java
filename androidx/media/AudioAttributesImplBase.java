...
class AudioAttributesImplBase implements AudioAttributesImpl {
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.b == ((AudioAttributesImplBase)object0).b) {
            ...
            int v2 = ((AudioAttributesImplBase)object0).d;
            if(v2 == -1) {
                int v4 = ((AudioAttributesImplBase)object0).a;
                if((v1 & 1) == 1) {
                    v3 = 7;
                }
                else if((v1 & 4) == 4) {
            ...
            if(v3 == 6) {
                return v == ((v1 | 4) & 273) && this.a == ((AudioAttributesImplBase)object0).a && this.d == v2;
            }
            if(v3 == 7) {
                v1 |= 1;
            }
            return v == (v1 & 273) && this.a == ((AudioAttributesImplBase)object0).a && this.d == v2;
        }
        return false;
    }
