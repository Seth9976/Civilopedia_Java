...
public class AdvertisingIdClient {
    ...
    public static void b(Info advertisingIdClient$Info0, long v, Throwable throwable0) {
        if(Math.random() <= 0.0) {
    ...
    public static Info getAdvertisingIdInfo(Context context0) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            advertisingIdClient0.a(false);
            advertisingIdClient$Info0 = advertisingIdClient0.c();
            AdvertisingIdClient.b(advertisingIdClient$Info0, SystemClock.elapsedRealtime() - v, null);
        }
        catch(Throwable throwable0) {
            try {
                AdvertisingIdClient.b(null, -1L, throwable0);
                throw throwable0;
            }
            catch(Throwable throwable1) {
        ...
        try {
            ...
            synchronized(advertisingIdClient0) {
                if(!advertisingIdClient0.c) {
                    ...
                    synchronized(object0) {
                        if(advertisingIdClient0.e == null || !advertisingIdClient0.e.l) {
                            throw new IOException("AdvertisingIdClient is not connected.");
                        }
                    }
                    try {
