...
public final class zze extends AbstractSafeParcelable {
    ...
    public final LoadAdError zzb() {
        ...
        if(iBinder0 != null) {
            ...
            if(iInterface0 instanceof zzdh) {
                return new LoadAdError(v, s, s1, adError0, ResponseInfo.zza(((zzdh)iInterface0)));
            }
            zzdh0 = new zzdf(iBinder0);
        }
        return new LoadAdError(v, s, s1, adError0, ResponseInfo.zza(zzdh0));
    }
}
