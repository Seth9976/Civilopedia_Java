...
public final class zzbu {
    ...
    public static JSONObject a(JSONObject jSONObject0, String[] arr_s) {
    ...
    public static void b(JsonWriter jsonWriter0, Object object0) {
        if(object0 == null) {
        ...
        if(object0 instanceof zzfbq) {
            zzbu.zzj(jsonWriter0, ((zzfbq)object0).zzd);
            return;
        }
        if(object0 instanceof Map) {
            ...
            for(Object object1: ((Map)object0).entrySet()) {
                ...
                if(object2 instanceof String) {
                    ...
                    zzbu.b(jsonWriter0.name(((String)object2)), object3);
                }
            }
    ...
    public static Bundle zza(JSONObject jSONObject0) {
        ...
        while(iterator0.hasNext()) {
            ...
            if(object1 == null) {
                ...
                if(object2 == null) {
                    zzcfi.zzj(("Expected JSONArray with at least 1 non-null element for key:" + s));
                }
                else if(object2 instanceof JSONObject) {
                    Bundle[] arr_bundle = new Bundle[v];
                    while(v1 < v) {
                        arr_bundle[v1] = jSONArray0.isNull(v1) ? null : zzbu.zza(jSONArray0.optJSONObject(v1));
                        ++v1;
                    }
                    ...
                    zzcfi.zzj(("JSONArray with unsupported type " + object2.getClass().getCanonicalName() + " for key:" + s));
                }
            }
                ...
                zzcfi.zzj(("Unsupported type for key:" + s));
            }
        }
        return bundle0;
    }
    ...
    public static String zzb(String s, JSONObject jSONObject0, String[] arr_s) {
        JSONObject jSONObject1 = zzbu.a(jSONObject0, arr_s);
        return jSONObject1 == null ? "" : jSONObject1.optString(arr_s[0], "");
    }

    public static List zzc(JSONArray jSONArray0, List list0) throws JSONException {
        if(list0 == null) {
            list0 = new ArrayList();
        }
        if(jSONArray0 != null) {
    ...
    public static List zzd(JsonReader jsonReader0) throws IllegalStateException, IOException {
        ...
        while(jsonReader0.hasNext()) {
            ((ArrayList)list0).add(jsonReader0.nextString());
        }
        jsonReader0.endArray();
        return list0;
    }

    public static JSONArray zze(JsonReader jsonReader0) throws IllegalStateException, IOException, JSONException {
    ...
    public static JSONObject zzf(JSONObject jSONObject0, String s) throws JSONException {
        try {
    ...
    public static JSONObject zzh(JsonReader jsonReader0) throws IllegalStateException, IOException, JSONException {
    ...
    public static void zzi(JsonWriter jsonWriter0, JSONArray jSONArray0) throws IOException {
        try {
            jsonWriter0.beginArray();
            for(int v = 0; v < jSONArray0.length(); ++v) {
    ...
    public static void zzj(JsonWriter jsonWriter0, JSONObject jSONObject0) throws IOException {
        try {
            jsonWriter0.beginObject();
            Iterator iterator0 = jSONObject0.keys();
            while(iterator0.hasNext()) {
    ...
    public static String zzl(zzfbq zzfbq0) {
        if(zzfbq0 != null) {
            StringWriter stringWriter0 = new StringWriter();
            try {
                JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
                zzbu.b(jsonWriter0, zzfbq0);
                jsonWriter0.close();
                return stringWriter0.toString();
            }
            catch(IOException iOException0) {
                zzcfi.zzh("Error when writing JSON.", iOException0);
            }
        }
        return null;
    }
