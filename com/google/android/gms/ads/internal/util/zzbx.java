...
public final class zzbx {
    public static JSONObject a(Context context0, Rect rect0) {
        JSONObject jSONObject0 = new JSONObject();
        jSONObject0.put("width", zzaw.zzb().zzb(context0, rect0.right - rect0.left));
        jSONObject0.put("height", zzaw.zzb().zzb(context0, rect0.bottom - rect0.top));
        jSONObject0.put("x", zzaw.zzb().zzb(context0, rect0.left));
        jSONObject0.put("y", zzaw.zzb().zzb(context0, rect0.top));
    ...
    public static WindowManager.LayoutParams zzb() {
        ...
        windowManager$LayoutParams0.flags = (int)(((Integer)zzay.zzc().zzb(zzbhz.zzgJ)));
    ...
    public static JSONObject zzc(String s, Context context0, Point point0, Point point1) {
        ...
        try {
            ...
            zzcfi.zzh("Error occurred while grabbing click signals.", exception0);
            return jSONObject0;
        }
        try {
            JSONObject jSONObject2 = new JSONObject();
            try {
                jSONObject2.put("x", zzaw.zzb().zzb(context0, point1.x));
                jSONObject2.put("y", zzaw.zzb().zzb(context0, point1.y));
                jSONObject2.put("start_x", zzaw.zzb().zzb(context0, point0.x));
                jSONObject2.put("start_y", zzaw.zzb().zzb(context0, point0.y));
                jSONObject0 = jSONObject2;
            }
            catch(JSONException jSONException0) {
                zzcfi.zzh("Error occurred while putting signals into JSON object.", jSONException0);
            }
    ...
    public static JSONObject zzd(Context context0, Map map0, Map map1, View view0) {
        String s;
        ...
        for(Object object0: map0.entrySet()) {
            ...
            if(view1 != null) {
                ...
                try {
                    jSONObject2.put("width", zzaw.zzb().zzb(context0, v));
                    jSONObject2.put("height", zzaw.zzb().zzb(context0, view1.getMeasuredHeight()));
                    jSONObject2.put("x", zzaw.zzb().zzb(context0, arr_v1[0] - arr_v[0]));
                    jSONObject2.put("y", zzaw.zzb().zzb(context0, arr_v1[1] - arr_v[1]));
                    jSONObject2.put("relative_to", "ad_view");
                    jSONObject1.put("frame", jSONObject2);
                    Rect rect0 = new Rect();
                    if(view1.getLocalVisibleRect(rect0)) {
                        jSONObject5 = zzbx.a(context0, rect0);
                    }
                    else {
                        jSONObject5 = new JSONObject();
                        jSONObject5.put("width", 0);
                        jSONObject5.put("height", 0);
                        jSONObject5.put("x", zzaw.zzb().zzb(context0, arr_v1[0] - arr_v[0]));
                        jSONObject5.put("y", zzaw.zzb().zzb(context0, arr_v1[1] - arr_v[1]));
                        jSONObject5.put("relative_to", "ad_view");
                    }
                    jSONObject1.put("visible_bounds", jSONObject5);
                    if(((Boolean)zzay.zzc().zzb(zzbhz.zzgG)).booleanValue() && ((String)map$Entry0.getKey()).equals("3010")) {
                    ...
                    jSONObject1.put("is_clickable", map1 != null && map1.containsKey(map$Entry1.getKey()) && view1.isClickable());
                    s = (String)map$Entry1.getKey();
    ...
    public static JSONObject zze(Context context0, View view0) {
        ...
        try {
            ...
            jSONObject0.put("is_keyguard_locked", zzs.zzz(context0));
        }
        catch(JSONException unused_ex) {
    ...
    public static JSONObject zzg(Context context0, View view0) {
        ...
        try {
            ...
            JSONObject jSONObject1 = new JSONObject();
            jSONObject1.put("width", zzaw.zzb().zzb(context0, view0.getMeasuredWidth()));
            jSONObject1.put("height", zzaw.zzb().zzb(context0, view0.getMeasuredHeight()));
            jSONObject1.put("x", zzaw.zzb().zzb(context0, arr_v[0]));
            jSONObject1.put("y", zzaw.zzb().zzb(context0, arr_v[1]));
            jSONObject1.put("maximum_visible_width", zzaw.zzb().zzb(context0, v));
            jSONObject1.put("maximum_visible_height", zzaw.zzb().zzb(context0, v1));
            jSONObject1.put("relative_to", "window");
            jSONObject0.put("frame", jSONObject1);
            Rect rect0 = new Rect();
            if(view0.getGlobalVisibleRect(rect0)) {
                jSONObject2 = zzbx.a(context0, rect0);
            }
            else {
                JSONObject jSONObject3 = new JSONObject();
                jSONObject3.put("width", 0);
                jSONObject3.put("height", 0);
                jSONObject3.put("x", zzaw.zzb().zzb(context0, arr_v[0]));
                jSONObject3.put("y", zzaw.zzb().zzb(context0, arr_v[1]));
        ...
        if(((Boolean)zzay.zzc().zzb(zzbhz.zzfi)).booleanValue()) {
            ...
            label_43:
                ...
                zzcfi.zzh("Cannot access method getTemplateTypeName: ", securityException0);
                goto label_43;
            }
            try {
            label_44:
            ...
            zzcfi.zzh("Could not log native template signal to JSON", jSONException0);
        }
        return jSONObject0;
    }

    public static boolean zzh(Context context0, zzfbl zzfbl0) {
        if(!zzfbl0.zzO) {
            return false;
        }
        ...
        String s = (String)zzay.zzc().zzb(zzbhz.zzgI);
        if(!s.isEmpty() && context0 != null) {
            for(Object object0: zzfpg.zzc(zzfoh.zzc(';')).zzd(s)) {
                if(((String)object0).equals("com.spears.civilopedia")) {
                    return true;
                }
                if(false) {
                    break;
    ...
    public static boolean zzi(int v) {
        return !((Boolean)zzay.zzc().zzb(zzbhz.zzcD)).booleanValue() || ((Boolean)zzay.zzc().zzb(zzbhz.zzcE)).booleanValue() || v <= 0xE9759F;
    }
