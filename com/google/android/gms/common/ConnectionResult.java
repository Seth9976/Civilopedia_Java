...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public static String a(int v) {
        switch(v) {
            ...
            default: {
                return f.e(v, "UNKNOWN_ERROR_CODE(", ")");
            }
        }
    }
    ...
    public boolean equals(Object object0) {
        ...
        return object0 instanceof ConnectionResult ? this.j == ((ConnectionResult)object0).j && Objects.equal(this.k, ((ConnectionResult)object0).k) && Objects.equal(this.l, ((ConnectionResult)object0).l) : false;
    }
    ...
    public String toString() {
        ...
        objects$ToStringHelper0.add("statusCode", ConnectionResult.a(this.j));
        objects$ToStringHelper0.add("resolution", this.k);
        objects$ToStringHelper0.add("message", this.l);
