...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public final void onCreate(Bundle bundle0) {
        ...
        if(bundle0 != null) {
            this.i = bundle0.getInt("resolution");
        }
        if(this.i != 1) {
            ...
            if(pendingIntent0 != null) {
                try {
                    ...
                    if(bundle1.getBoolean("notify_manager", true)) {
                        ...
                        Log.e("GoogleApiActivity", e.f("Activity not found while launching ", pendingIntent0.toString(), "."), activityNotFoundException0);
                    }
                    this.i = 1;
                    this.finish();
                }
    ...
    public final void onSaveInstanceState(Bundle bundle0) {
        bundle0.putInt("resolution", this.i);
