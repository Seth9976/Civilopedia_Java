...
public class LifecycleCallback {
    public final LifecycleFragment i;

    public LifecycleCallback(LifecycleFragment lifecycleFragment0) {
        this.i = lifecycleFragment0;
    }

    public static LifecycleFragment a(LifecycleActivity lifecycleActivity0) {
    ...
    public static LifecycleFragment getFragment(Activity activity0) {
        return LifecycleCallback.a(new LifecycleActivity(activity0));
    }
