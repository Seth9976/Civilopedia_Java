...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public Bitmap get() {
        ...
        byte[] arr_b;
        if(!this.m) {
            DataInputStream dataInputStream0 = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(((ParcelFileDescriptor)Preconditions.checkNotNull(this.j))));
            try {
    ...
    public void release() {
        if(!this.m) {
            try {
                ((ParcelFileDescriptor)Preconditions.checkNotNull(this.j)).close();
            }
            catch(IOException iOException0) {
    ...
    public final void writeToParcel(Parcel parcel0, int v) {
        ...
        File file1;
        if(this.j == null) {
            Bitmap bitmap0 = (Bitmap)Preconditions.checkNotNull(this.l);
            ...
            try {
                ...
                this.j = ParcelFileDescriptor.open(file1, 0x10000000);
            }
        ...
        SafeParcelWriter.writeParcelable(parcel0, 2, this.j, v | 1, false);
