...
public class DataBufferSafeParcelable extends AbstractDataBuffer {
    ...
    public static Builder buildDataHolder() {
        return DataHolder.builder(DataBufferSafeParcelable.k);
    }

    @KeepForSdk
    public SafeParcelable get(int v) {
        DataHolder dataHolder0 = (DataHolder)Preconditions.checkNotNull(this.i);
        ...
        SafeParcelable safeParcelable0 = (SafeParcelable)this.j.createFromParcel(parcel0);
        parcel0.recycle();
