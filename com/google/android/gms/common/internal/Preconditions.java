...
public final class Preconditions {
    ...
    public static double checkArgumentInRange(double f, double f1, double f2, String s) {
        if(f < f1) {
            throw new IllegalArgumentException(Preconditions.a("%s is out of range of [%f, %f] (too low)", new Object[]{s, f1, f2}));
        }
        if(f > f2) {
            throw new IllegalArgumentException(Preconditions.a("%s is out of range of [%f, %f] (too high)", new Object[]{s, f1, f2}));
        }
        return f;
    }
    ...
    public static int checkArgumentInRange(int v, int v1, int v2, String s) {
        if(v < v1) {
            throw new IllegalArgumentException(Preconditions.a("%s is out of range of [%d, %d] (too low)", new Object[]{s, v1, v2}));
        }
        if(v > v2) {
            throw new IllegalArgumentException(Preconditions.a("%s is out of range of [%d, %d] (too high)", new Object[]{s, v1, v2}));
        }
        return v;
    }
    ...
    public static void checkHandlerThread(Handler handler0) {
        ...
        if(looper0 != handler0.getLooper()) {
            ...
            throw new IllegalStateException(f.k("Must be called on ", handler0.getLooper().getThread().getName(), " thread, but got ", s, "."));
        }
    }
    ...
    @CanIgnoreReturnValue
    @EnsuresNonNull({"#1"})
    public static String checkNotEmpty(String s) [...] // Potential decryptor
    ...
    @KeepForSdk
    @FormatMethod
    public static void checkState(boolean z, @FormatString String s, Object[] arr_object) {
        if(!z) {
