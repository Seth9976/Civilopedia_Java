...
public class SafeParcelReader {
    ...
    public static void a(Parcel parcel0, int v, int v1) {
        if(v != v1) {
            throw new ParseException(e.h(f.n("Expected size ", v1, " got ", v, " (0x"), Integer.toHexString(v), ")"), parcel0);
        }
    }

    public static void b(Parcel parcel0, int v, int v1) {
        int v2 = SafeParcelReader.readSize(parcel0, v);
        if(v2 != v1) {
            throw new ParseException(e.h(f.n("Expected size ", v1, " got ", v2, " (0x"), Integer.toHexString(v2), ")"), parcel0);
        }
    }
    ...
    public static boolean readBoolean(Parcel parcel0, int v) {
        SafeParcelReader.b(parcel0, v, 4);
    ...
    public static Boolean readBooleanObject(Parcel parcel0, int v) {
        ...
        SafeParcelReader.a(parcel0, v1, 4);
    ...
    public static double readDouble(Parcel parcel0, int v) {
        SafeParcelReader.b(parcel0, v, 8);
    ...
    public static Double readDoubleObject(Parcel parcel0, int v) {
        ...
        SafeParcelReader.a(parcel0, v1, 8);
        return parcel0.readDouble();
    }
    ...
    public static int validateObjectHeader(Parcel parcel0) {
        ...
        if(v3 < v2 || v3 > parcel0.dataSize()) {
            throw new ParseException(f.d(v2, v3, "Size read is invalid start=", " end="), parcel0);
        }
        return v3;
    }
}
