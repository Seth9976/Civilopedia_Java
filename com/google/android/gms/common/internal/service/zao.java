...
public final class zao extends GoogleApi implements TelemetryLoggingClient {
    ...
    static {
        ...
        zao.k = new Api("ClientTelemetry.API", new f(), api$ClientKey0);  // 初始化器: Lcom/google/android/gms/common/api/Api$AbstractClientBuilder;-><init>()V
    }

    public zao(Context context0, TelemetryLoggingOptions telemetryLoggingOptions0) {
        super(context0, zao.k, telemetryLoggingOptions0, Settings.DEFAULT_SETTINGS);
    }
