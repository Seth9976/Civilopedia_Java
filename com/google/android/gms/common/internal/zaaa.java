...
public final class zaaa extends Button {
    ...
    public static final int a(int v, int v1, int v2, int v3) {
        switch(v) {
            case 0: {
                return v1;
            }
    ...
    public final void zaa(Resources resources0, int v, int v1) {
        ...
        this.setMinWidth(v2);
        int v3 = zaaa.a(v1, drawable.common_google_signin_btn_icon_dark, drawable.common_google_signin_btn_icon_light, drawable.common_google_signin_btn_icon_light);
        int v4 = zaaa.a(v1, drawable.common_google_signin_btn_text_dark, drawable.common_google_signin_btn_text_light, drawable.common_google_signin_btn_text_light);
        switch(v) {
            case 0: 
            case 1: {
                v3 = v4;
        ...
        Drawable drawable0 = w.B(resources0.getDrawable(v3));
        ...
        this.setTextColor(((ColorStateList)Preconditions.checkNotNull(resources0.getColorStateList(zaaa.a(v1, color.common_google_signin_btn_text_dark, color.common_google_signin_btn_text_light, color.common_google_signin_btn_text_light)))));
        switch(v) {
            case 0: {
