...
public final class zaz extends RemoteCreator {
    ...
    public static View zaa(Context context0, int v, int v1) throws RemoteCreatorException {
        try {
            ...
            return (View)ObjectWrapper.unwrap(((zam)zaz.c.a(context0)).zae(iObjectWrapper0, zax0));
        }
        catch(Exception exception0) {
            throw new RemoteCreatorException(f.d(v, v1, "Could not get button with size ", " and color "), exception0);
        }
    }
}
