...
public class FastParser {
    ...
    public final String f(BufferedReader bufferedReader0, char[] arr_c, StringBuilder stringBuilder0, char[] arr_c1) {
        switch(this.b(bufferedReader0)) {
            case 34: {
                return FastParser.a(bufferedReader0, arr_c, stringBuilder0, arr_c1);
            }
            case 110: {
                this.l(bufferedReader0, FastParser.g);
                return null;
    ...
    public final ArrayList i(BufferedReader bufferedReader0, i i0) {
        int v = this.b(bufferedReader0);
        if(v == 110) {
            this.l(bufferedReader0, FastParser.g);
            return null;
        ...
        if(v == 91) {
            ...
            while(true) {
                ...
                switch(this.b(bufferedReader0)) {
                    ...
                    default: {
                        bufferedReader0.reset();
                        arrayList0.add(i0.a(this, bufferedReader0));
                        break;
                    }
                }
            }
    ...
    public final void k(int v) {
        Stack stack0 = this.f;
        if(stack0.isEmpty()) {
            throw new ParseException(A.f.e(v, "Expected state ", " but had empty stack"));
        }
        int v1 = (int)(((Integer)stack0.pop()));
        if(v1 != v) {
            throw new ParseException(A.f.d(v, v1, "Expected state ", " but had "));
        }
    }
        ...
        if(s != null) {
            while(s != null) {
                ...
                if(fastJsonResponse$Field0 == null) {
                    ...
                    boolean z = fastJsonResponse$Field0.k;
                    ...
                    switch(v) {
                        ...
                        case 11: {
                            String s2 = fastJsonResponse$Field0.n;
                            if(z) {
                                int v7 = this.b(bufferedReader0);
                                if(v7 == 110) {
                                    this.l(bufferedReader0, arr_c3);
                                    fastJsonResponse0.addConcreteTypeArrayInternal(fastJsonResponse$Field0, s2, null);
                                }
                                else {
                                    stack0.push(5);
                                    if(v7 != 91) {
                                    ...
                                    fastJsonResponse0.addConcreteTypeArrayInternal(fastJsonResponse$Field0, s2, this.j(bufferedReader0, fastJsonResponse$Field0));
                                }
                                break;
                            }
                            else {
                                ...
                                if(v8 == 110) {
                                    this.l(bufferedReader0, arr_c3);
                                    fastJsonResponse0.addConcreteTypeInternal(fastJsonResponse$Field0, s2, null);
                                }
                                else {
                                    stack0.push(1);
                                    if(v8 != 0x7B) {
                                    ...
                                    try {
                                        ...
                                        fastJsonResponse0.addConcreteTypeInternal(fastJsonResponse$Field0, s2, fastJsonResponse1);
                                    }
                                    catch(InstantiationException instantiationException0) {
                                        throw new ParseException("Error instantiating inner object", instantiationException0);
                                    }
        ...
        try {
            ...
            switch(v1) {
                ...
                case 91: {
                    ...
                    fastJsonResponse0.addConcreteTypeArrayInternal(fastJsonResponse$Field0, fastJsonResponse$Field0.n, arrayList0);
                    break;
                }
                case 0x7B: {
                    stack0.push(1);
