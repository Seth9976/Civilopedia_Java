...
public abstract class FastSafeParcelableJsonResponse extends FastJsonResponse implements SafeParcelable {
    ...
    public boolean equals(Object object0) {
        ...
        for(Object object1: this.getFieldMappings().values()) {
            ...
            if(this.b(fastJsonResponse$Field0)) {
                if(((FastJsonResponse)object0).b(fastJsonResponse$Field0) && Objects.equal(this.a(fastJsonResponse$Field0), ((FastJsonResponse)object0).a(fastJsonResponse$Field0))) {
                    continue;
                }
                return false;
            }
            if(((FastJsonResponse)object0).b(fastJsonResponse$Field0)) {
                return false;
            }
            if(false) {
                break;
    ...
    public int hashCode() {
        ...
        for(Object object0: this.getFieldMappings().values()) {
            ...
            if(this.b(fastJsonResponse$Field0)) {
                v = v * 0x1F + Preconditions.checkNotNull(this.a(fastJsonResponse$Field0)).hashCode();
            }
        }
        return v;
    }
