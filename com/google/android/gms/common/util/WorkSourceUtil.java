...
public class WorkSourceUtil {
    ...
    static {
        ...
        WorkSourceUtil.i = method7;
        WorkSourceUtil.j = null;
    }
    ...
    public static boolean hasWorkSourcePermission(Context context0) {
        synchronized(WorkSourceUtil.class) {
            boolean z = false;
            Boolean boolean0 = WorkSourceUtil.j;
            if(boolean0 != null) {
            ...
            if(j.checkSelfPermission(context0, "android.permission.UPDATE_DEVICE_STATS") == 0) {
                z = true;
            }
            WorkSourceUtil.j = Boolean.valueOf(z);
            return z;
        }
    }
