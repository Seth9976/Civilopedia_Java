...
public final class SupportFragmentWrapper extends Stub {
    ...
    public SupportFragmentWrapper(h h0) {
        this.i = h0;
    }

    @KeepForSdk
    public static SupportFragmentWrapper wrap(h h0) {
        return h0 == null ? null : new SupportFragmentWrapper(h0);
    }
    ...
    public final IFragmentWrapper zze() {
        return SupportFragmentWrapper.wrap(this.i.getParentFragment());
    }

    @Override  // com.google.android.gms.dynamic.IFragmentWrapper
    public final IFragmentWrapper zzf() {
        return SupportFragmentWrapper.wrap(this.i.getTargetFragment());
    }
