...
public final class zzabu extends zzacb {
    ...
    static {
        zzabu.CREATOR = new i(8);
    }

    public zzabu(Parcel parcel0) {
        super("COMM");
    ...
    public zzabu(String s, String s1, String s2) {
        super("COMM");
        this.zza = s;
        this.zzb = s1;
        this.zzc = s2;
    ...
    public final boolean equals(Object object0) {
        ...
        if(object0 != null) {
            ...
            return zzabu.class == class0 && zzeg.zzS(this.zzb, ((zzabu)object0).zzb) && zzeg.zzS(this.zza, ((zzabu)object0).zza) && zzeg.zzS(this.zzc, ((zzabu)object0).zzc);
        }
        return false;
    }
