...
public final class zzbcy extends AbstractSafeParcelable {
    ...
    static {
        zzbcy.CREATOR = new zzbcz();
    }

    public zzbcy(String s, long v, String s1, String s2, String s3, Bundle bundle0, boolean z, long v1, String s4, int v2) {
        this.zza = s;
        this.zzb = v;
        if(s1 == null) {
            s1 = "";
    ...
    public static zzbcy zza(Uri uri0) {
        try {
            ...
            if(list0.size() != 2) {
                zzcfi.zzj(("Expected 2 path parts for namespace and id, found :" + list0.size()));
                return null;
            }
            ...
            return new zzbcy(s1, v, s, ((String)object0), ((String)object1), bundle0, z, 0L, "", 0);
        }
        catch(NullPointerException | NumberFormatException nullPointerException0) {
        }
        zzcfi.zzk("Unable to parse Uri into cache offering.", nullPointerException0);
        return null;
    }
}
