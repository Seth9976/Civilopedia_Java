...
public final class zzbkp extends AbstractSafeParcelable {
    ...
    static {
        zzbkp.CREATOR = new zzbkq();
    }

    @Constructor
    public zzbkp(@Param(id = 1) int v, @Param(id = 2) boolean z, @Param(id = 3) int v1, @Param(id = 4) boolean z1, @Param(id = 5) int v2, @Param(id = 6) zzff zzff0, @Param(id = 7) boolean z2, @Param(id = 8) int v3) {
        this.zza = v;
        this.zzb = z;
        this.zzc = v1;
        this.zzd = z1;
    ...
    public zzbkp(NativeAdOptions nativeAdOptions0) {
        this(4, nativeAdOptions0.shouldReturnUrlsForImageAssets(), nativeAdOptions0.getImageOrientation(), nativeAdOptions0.shouldRequestMultipleImages(), nativeAdOptions0.getAdChoicesPlacement(), (nativeAdOptions0.getVideoOptions() == null ? null : new zzff(nativeAdOptions0.getVideoOptions())), nativeAdOptions0.zza(), nativeAdOptions0.getMediaAspectRatio());
    }
    ...
    public static com.google.android.gms.ads.nativead.NativeAdOptions zza(zzbkp zzbkp0) {
