...
public final class zzbna extends RemoteCreator {
    ...
    public final Object getRemoteCreator(IBinder iBinder0) {
        ...
        return iInterface0 instanceof zzbli ? ((zzbli)iInterface0) : new zzblg(iBinder0);
    }

    public final zzblf zza(Context context0, FrameLayout frameLayout0, FrameLayout frameLayout1) {
        try {
            ...
            IBinder iBinder0 = ((zzbli)this.a(context0)).zze(iObjectWrapper0, iObjectWrapper1, iObjectWrapper2, 221908000);
            if(iBinder0 != null) {
        ...
        zzcfi.zzk("Could not create remote NativeAdViewDelegate.", remoteException0);
        return null;
    }
}
