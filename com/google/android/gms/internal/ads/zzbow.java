...
public final class zzbow {
    public static final Intent zza(Uri uri0, Context context0, zzaoc zzaoc0, View view0) {
        if(uri0 == null) {
            return null;
        }
    ...
    public static final Intent zzb(Intent intent0, ResolveInfo resolveInfo0, Context context0, zzaoc zzaoc0, View view0) {
    ...
    @VisibleForTesting
    public static final ResolveInfo zzc(Intent intent0, Context context0, zzaoc zzaoc0, View view0) {
        return zzbow.zzd(intent0, new ArrayList(), context0, zzaoc0, view0);
    }

    @VisibleForTesting
    public static final ResolveInfo zzd(Intent intent0, ArrayList arrayList0, Context context0, zzaoc zzaoc0, View view0) {
        ...
        try {
            ...
            zzt.zzo().zzt(throwable0, "OpenSystemBrowserHandler.getDefaultBrowserResolverForIntent");
        }
        return resolveInfo0;
    }
}
