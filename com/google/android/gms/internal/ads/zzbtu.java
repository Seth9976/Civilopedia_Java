...
public final class zzbtu {
    ...
    public zzbtu(JSONObject jSONObject0) throws JSONException {
        ...
        this.zzf = zzbtw.zza(jSONObject0, "clickurl");
        this.zzg = zzbtw.zza(jSONObject0, "imp_urls");
        this.zzh = zzbtw.zza(jSONObject0, "downloaded_imp_urls");
        this.zzj = zzbtw.zza(jSONObject0, "fill_urls");
        this.zzl = zzbtw.zza(jSONObject0, "video_start_urls");
        this.zzn = zzbtw.zza(jSONObject0, "video_complete_urls");
        this.zzm = zzbtw.zza(jSONObject0, "video_reward_urls");
        ...
        this.zzi = jSONObject1 == null ? null : zzbtw.zza(jSONObject1, "manual_impression_urls");
        ...
        this.zzt = zzbtw.zza(jSONObject0, "template_ids");
