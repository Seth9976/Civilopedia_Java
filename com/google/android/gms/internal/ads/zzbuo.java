...
public abstract class zzbuo extends zzaqx implements zzbup {
    ...
    public final boolean a(int v, Parcel parcel0, Parcel parcel1) {
        switch(v) {
            ...
            case 15: {
                ...
                parcel1.writeNoException();
                zzaqy.zzg(parcel1, iObjectWrapper2);
                return true;
            }
            case 16: {
    ...
    public static zzbup zzb(IBinder iBinder0) {
        if(iBinder0 == null) {
            return null;
        }
        ...
        return iInterface0 instanceof zzbup ? ((zzbup)iInterface0) : new zzbun(iBinder0);
    }
}
