...
public final class zzcy {
    ...
    static {
        zzcy.a = new byte[]{0, 0, 0, 1};
        zzcy.b = new String[]{"", "A", "B", "C"};
    }
    ...
    public static String zzb(int v, boolean z, int v1, int v2, int[] arr_v, int v3) {
        StringBuilder stringBuilder0 = new StringBuilder(zzeg.zzH("hvc1.%s%d.%X.%c%d", new Object[]{zzcy.b[v], v1, v2, Character.valueOf(((char)(z ? 72 : 76))), v3}));
        int v4;
    ...
    public static byte[] zzc(byte[] arr_b, int v, int v1) {
        ...
        System.arraycopy(zzcy.a, 0, arr_b1, 0, 4);
