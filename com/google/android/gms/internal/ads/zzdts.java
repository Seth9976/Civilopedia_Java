...
public final class zzdts extends FrameLayout {
    ...
    public zzdts(Context context0, View view0, zzas zzas0) {
        super(context0);
    ...
    public final void removeAllViews() {
        ...
        for(int v1 = 0; v1 < this.getChildCount(); ++v1) {
            ...
            if(view0 != null && view0 instanceof zzcli) {
                arrayList0.add(((zzcli)view0));
            }
        }
        super.removeAllViews();
        int v2 = arrayList0.size();
        for(int v = 0; v < v2; ++v) {
            ((zzcli)arrayList0.get(v)).destroy();
        }
    }
}
