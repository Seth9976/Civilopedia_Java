...
public final class zzeed {
    public static Cursor a(SQLiteDatabase sQLiteDatabase0, int v) {
    ...
    public static void b(SQLiteDatabase sQLiteDatabase0, String s) {
    ...
    public static void c(SQLiteDatabase sQLiteDatabase0, String s) {
        ContentValues contentValues0 = new ContentValues();
        contentValues0.put("value", 0);
    ...
    public static int zza(SQLiteDatabase sQLiteDatabase0, int v) {
        ...
        Cursor cursor0 = zzeed.a(sQLiteDatabase0, v);
    ...
    public static long zzb(SQLiteDatabase sQLiteDatabase0, int v) {
        long v1;
        Cursor cursor0 = zzeed.a(sQLiteDatabase0, 2);
        if(cursor0.getCount() > 0) {
            cursor0.moveToNext();
    ...
    public static void zze(SQLiteDatabase sQLiteDatabase0) {
        zzeed.b(sQLiteDatabase0, "failed_requests");
        zzeed.b(sQLiteDatabase0, "total_requests");
        zzeed.b(sQLiteDatabase0, "completed_requests");
        ContentValues contentValues0 = new ContentValues();
    ...
    public static void zzf(SQLiteDatabase sQLiteDatabase0) {
        ...
        zzeed.c(sQLiteDatabase0, "failed_requests");
        zzeed.c(sQLiteDatabase0, "total_requests");
        zzeed.c(sQLiteDatabase0, "completed_requests");
    }
