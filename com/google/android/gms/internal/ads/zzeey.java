...
public final class zzeey implements DialogInterface.OnCancelListener {
    ...
    public zzeey(zzees zzees0, String s, zzdwh zzdwh0, Activity activity0, zzfgp zzfgp0, zzl zzl0) {
        this.zza = zzees0;
        this.zzb = s;
        this.zzc = zzdwh0;
        this.zzd = activity0;
