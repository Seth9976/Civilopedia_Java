...
public final class zzfdb implements Runnable {
    public final InputStream zza;
    public final ParcelFileDescriptor zzb;

    public zzfdb(InputStream inputStream0, ParcelFileDescriptor parcelFileDescriptor0) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    zzfda.zza(throwable1, throwable2);
                }
                throw throwable1;
            }
            parcelFileDescriptor$AutoCloseOutputStream0.close();
            ...
            if(inputStream0 != null) {
                try {
                    ...
                    try {
                        zzfda.zza(throwable0, throwable3);
                        throw throwable0;
                    label_19:
                        if(inputStream0 != null) {
                            inputStream0.close();
