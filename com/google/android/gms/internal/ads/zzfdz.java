...
public final class zzfdz implements zzfdy {
    ...
    public zzfdz(zzl zzl0, String s, int v, String s1, zzw zzw0) {
        ...
        if(hashSet0.contains("extras")) {
            arrayList0.add(zzfdz.a(zzl0.zzc));
        }
        ...
        if(hashSet0.contains("networkExtras")) {
            arrayList0.add(zzfdz.a(zzl0.zzm));
        }
        if(hashSet0.contains("customTargeting")) {
            arrayList0.add(zzfdz.a(zzl0.zzn));
        }
    ...
    public static String a(Bundle bundle0) {
        ...
        for(Object object0: new TreeSet(bundle0.keySet())) {
            ...
            if(object1 == null) {
                ...
                s = object1 instanceof Bundle ? zzfdz.a(((Bundle)object1)) : object1.toString();
            }
    ...
    public final boolean equals(Object object0) {
        return object0 instanceof zzfdz ? Arrays.equals(this.a, ((zzfdz)object0).a) : false;
    }
    ...
    public final String toString() {
        return "[PoolKey#" + Arrays.hashCode(this.a) + " " + Arrays.toString(this.a) + "]";
    }
}
