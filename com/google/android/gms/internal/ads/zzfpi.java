...
public final class zzfpi {
    @CheckForNull
    public static String zza(@CheckForNull String s) {
        return s == null || s.isEmpty() ? null : s;
    }

    public static String zzb(@CheckForNull String s, @CheckForNull Object[] arr_object) {
        String s1;
        int v = 0;
        ...
        StringBuilder stringBuilder0 = new StringBuilder(arr_object.length * 16 + s.length());
        int v2 = 0;
    ...
    public static String zzc(@CheckForNull String s) {
        return s == null ? "" : s;
    }

    public static boolean zzd(@CheckForNull String s) {
