...
public final class zzu implements Parcelable {
    ...
    static {
        zzu.CREATOR = new i(29);
    }

    public zzu(Parcel parcel0) {
    ...
    public zzu(UUID uUID0, String s, String s1, byte[] arr_b) {
        uUID0.getClass();
        this.zza = uUID0;
        this.zzb = null;
        this.zzc = s1;
    ...
    public final boolean equals(Object object0) {
        if(!(object0 instanceof zzu)) {
            return false;
        }
        return object0 == this ? true : zzeg.zzS(this.zzb, ((zzu)object0).zzb) && zzeg.zzS(this.zzc, ((zzu)object0).zzc) && zzeg.zzS(this.zza, ((zzu)object0).zza) && Arrays.equals(this.zzd, ((zzu)object0).zzd);
    }
    ...
    public final int hashCode() {
        ...
        if(v == 0) {
            ...
            v = f.b((this.zza.hashCode() * 0x1F + (this.zzb == null ? 0 : this.zzb.hashCode())) * 0x1F, 0x1F, this.zzc) + v1;
            this.i = v;
        }
        return v;
    }
