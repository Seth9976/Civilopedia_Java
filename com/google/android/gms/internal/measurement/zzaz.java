...
public final class zzaz extends zzaw {
    public static zzao b(zzg zzg0, List list0) {
        ...
        if(!(zzap1 instanceof zzae)) {
            throw new IllegalArgumentException(f.h("FN requires an ArrayValue of parameter names found ", zzap1.getClass().getCanonicalName()));
        }
    ...
    public final zzap zza(String s, zzg zzg0, List list0) {
        ...
        switch(zzh.zze(s).ordinal()) {
            case 2: {
                zzap zzap1 = zzg0.zzb(((zzap)u9.c(zzbl.zzc, 3, list0, 0)));
                String s1 = zzg0.zzb(((zzap)list0.get(1))).zzi();
                zzap zzap2 = zzg0.zzb(((zzap)list0.get(2)));
                if(!(zzap2 instanceof zzae)) {
                    throw new IllegalArgumentException(f.h("Function arguments for Apply are not a list found ", zzap2.getClass().getCanonicalName()));
                }
                if(s1.isEmpty()) {
                    throw new IllegalArgumentException("Function name for apply is undefined");
                }
                return zzap1.zzbN(s1, zzg0, ((zzae)zzap2).zzm());
            }
            case 11: {
            ...
            case 57: {
                return list0.isEmpty() ? zzap.zzj : new zzag("return", zzg0.zzb(((zzap)u9.c(zzbl.zzaf, 1, list0, 0))));
            }
            case 60: {
                zzap zzap9 = zzg0.zzb(((zzap)u9.c(zzbl.zzai, 3, list0, 0)));
            ...
            case 61: {
                return zzg0.zzb(((zzap)u9.c(zzbl.zzaj, 3, list0, 0))).zzg().booleanValue() ? zzg0.zzb(((zzap)list0.get(1))) : zzg0.zzb(((zzap)list0.get(2)));
            }
            default: {
                this.a(s);
                throw null;
