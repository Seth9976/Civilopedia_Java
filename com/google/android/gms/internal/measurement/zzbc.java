...
public final class zzbc extends zzaw {
    ...
    public final zzap zza(String s, zzg zzg0, List list0) {
        switch(zzh.zze(s).ordinal()) {
            case 1: {
                zzap zzap0 = zzg0.zzb(((zzap)u9.c(zzbl.zzb, 2, list0, 0)));
                return zzap0.zzg().booleanValue() ? zzg0.zzb(((zzap)list0.get(1))) : zzap0;
            }
            case 0x2F: {
                return new zzaf(Boolean.valueOf(!zzg0.zzb(((zzap)u9.c(zzbl.zzV, 1, list0, 0))).zzg().booleanValue()));
            }
            case 50: {
                zzap zzap1 = zzg0.zzb(((zzap)u9.c(zzbl.zzY, 2, list0, 0)));
