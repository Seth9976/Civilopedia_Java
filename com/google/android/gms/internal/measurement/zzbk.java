...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String s, zzg zzg0, List list0) {
        ...
        switch(zzh.zze(s).ordinal()) {
            case 3: {
                zzap zzap0 = zzg0.zzb(((zzap)u9.c(zzbl.zzd, 2, list0, 0)));
                if(!(zzap0 instanceof zzat)) {
                    throw new IllegalArgumentException(f.h("Expected string for assign var. got ", zzap0.getClass().getCanonicalName()));
                }
                if(!zzg0.zzh(zzap0.zzi())) {
                    throw new IllegalArgumentException(f.h("Attempting to assign undefined value ", zzap0.zzi()));
                }
            ...
            case 14: {
                ...
                while(v < list0.size() - 1) {
                    ...
                    if(!(zzap2 instanceof zzat)) {
                        throw new IllegalArgumentException(f.h("Expected string for const name. got ", zzap2.getClass().getCanonicalName()));
                    }
            ...
            case 33: {
                zzap zzap9 = zzg0.zzb(((zzap)u9.c(zzbl.zzH, 1, list0, 0)));
                if(!(zzap9 instanceof zzat)) {
                    throw new IllegalArgumentException(f.h("Expected string for get var. got ", zzap9.getClass().getCanonicalName()));
                }
                return zzg0.zzd(zzap9.zzi());
            }
            case 35: 
            case 36: {
                zzap zzap10 = zzg0.zzb(((zzap)u9.c(zzbl.zzK, 2, list0, 0)));
            ...
            case 58: {
                zzap zzap12 = zzg0.zzb(((zzap)u9.c(zzbl.zzag, 3, list0, 0)));
                zzap zzap13 = zzg0.zzb(((zzap)list0.get(1)));
                zzap zzap14 = zzg0.zzb(((zzap)list0.get(2)));
                if(zzap12 == zzap.zzf || zzap12 == zzap.zzg) {
                    throw new IllegalStateException(f.j("Can\'t set property ", zzap13.zzi(), " of ", zzap12.zzi()));
                }
            ...
            case 62: {
                zzap zzap15 = zzg0.zzb(((zzap)u9.c(zzbl.zzak, 1, list0, 0)));
            ...
            case 0x40: {
                zzh.zzi(zzbl.zzam.name(), 1, list0);
                for(Object object1: list0) {
                    zzap zzap16 = zzg0.zzb(((zzap)object1));
                    if(!(zzap16 instanceof zzat)) {
                        throw new IllegalArgumentException(f.h("Expected string for var name. got ", zzap16.getClass().getCanonicalName()));
                    }
