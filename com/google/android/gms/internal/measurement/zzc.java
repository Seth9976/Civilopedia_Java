...
public final class zzc {
    ...
    public final void zzc(zzgs zzgs0) throws zzd {
        zzai zzai0;
        try {
            zzf zzf0 = this.a;
            this.b = zzf0.b.zza();
            if(zzf0.zza(this.b, ((zzgx[])zzgs0.zzc().toArray(new zzgx[0]))) instanceof zzag) {
            ...
            while(true) {
                ...
                for(Object object1: ((zzgq)object0).zzc()) {
                    zzap zzap0 = zzf0.zza(this.b, new zzgx[]{((zzgx)object1)});
