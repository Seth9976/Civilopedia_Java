...
public final class zzi {
    public static zzap zza(zzgx zzgx0) {
        if(zzgx0 == null) {
            return zzap.zzf;
        }
        switch(zzgx0.zzj() - 1) {
            case 1: {
                return zzgx0.zzi() ? new zzat("") : zzap.zzm;
            }
            case 2: {
                return zzgx0.zzh() ? new zzah(zzgx0.zza()) : new zzah(null);
            }
            case 3: {
                return zzgx0.zzg() ? new zzaf(Boolean.valueOf(zzgx0.zzf())) : new zzaf(null);
            }
            case 4: {
                ArrayList arrayList0 = new ArrayList();
                for(Object object0: zzgx0.zze()) {
                    arrayList0.add(zzi.zza(((zzgx)object0)));
                }
