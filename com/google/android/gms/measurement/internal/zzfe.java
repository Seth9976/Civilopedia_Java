...
public final class zzfe {
    ...
    public zzfe(r r0, String s, Bundle bundle0) {
        this.d = r0;
        super();
    ...
    public final Bundle zza() {
        if(this.c == null) {
            r r0 = this.d;
            String s = r0.d().getString(this.a, null);
            if(s != null) {
                try {
                    ...
                    for(int v = 0; true; ++v) {
                        ...
                        try {
                            ...
                            switch(s2) {
                                ...
                                default: {
                                    r0.a.zzay().zzd().zzb("Unrecognized persisted bundle type. Type", s2);
                                }
                            }
                        }
                        catch(JSONException | NumberFormatException unused_ex) {
                            r0.a.zzay().zzd().zza("Error reading value from SharedPreferences. Value dropped");
                        }
                    }
                }
                catch(JSONException unused_ex) {
                    u9.o(r0.a, "Error loading bundle from SharedPreferences. Values will be lost");
                }
            }
            if(this.c == null) {
                this.c = this.b;
        ...
        if(bundle0.size() == 0) {
            ...
            for(Object object0: bundle0.keySet()) {
                ...
                if(object1 != null) {
                    try {
                        ...
                        if(object1 instanceof String) {
                            ...
                            if(object1 instanceof Long) {
                                ...
                                r0.a.zzay().zzd().zzb("Cannot serialize bundle value to SharedPreferences. Type", object1.getClass());
                            }
                            continue;
                        }
                        jSONArray0.put(jSONObject0);
                    ...
                    r0.a.zzay().zzd().zzb("Cannot serialize bundle value to SharedPreferences", jSONException0);
                }
            }
