...
public final class zzli extends AbstractSafeParcelable {
    ...
    static {
        zzli.CREATOR = new zzlj();
    }

    public zzli(int v, String s, long v1, Long long0, Float float0, String s1, String s2, Double double0) {
        this.zza = v;
        this.zzb = s;
        this.zzc = v1;
        this.zzd = long0;
    ...
    public zzli(long v, Object object0, String s, String s1) {
