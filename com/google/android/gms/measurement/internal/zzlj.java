...
public final class zzlj implements Parcelable.Creator {
    public static void a(zzli zzli0, Parcel parcel0) {
        int v = SafeParcelWriter.beginObjectHeader(parcel0);
        SafeParcelWriter.writeInt(parcel0, 1, zzli0.zza);
        SafeParcelWriter.writeString(parcel0, 2, zzli0.zzb, false);
        SafeParcelWriter.writeLong(parcel0, 3, zzli0.zzc);
        SafeParcelWriter.writeLongObject(parcel0, 4, zzli0.zzd, false);
        SafeParcelWriter.writeFloatObject(parcel0, 5, null, false);
        SafeParcelWriter.writeString(parcel0, 6, zzli0.zze, false);
        SafeParcelWriter.writeString(parcel0, 7, zzli0.zzf, false);
        SafeParcelWriter.writeDoubleObject(parcel0, 8, zzli0.zzg, false);
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        return new zzli(v2, s, v1, long0, float0, s1, s2, double0);
    }
