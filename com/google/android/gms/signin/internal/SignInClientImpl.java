...
public class SignInClientImpl extends GmsClient implements zae {
    ...
    public SignInClientImpl(Context context0, Looper looper0, boolean z, ClientSettings clientSettings0, Bundle bundle0, ConnectionCallbacks googleApiClient$ConnectionCallbacks0, OnConnectionFailedListener googleApiClient$OnConnectionFailedListener0) {
        ...
        this.Q = bundle0;
        this.R = clientSettings0.zab();
    }

    @Override  // com.google.android.gms.common.internal.BaseGmsClient
    public final Bundle b() {
        ClientSettings clientSettings0 = this.P;
        Bundle bundle0 = this.Q;
        if(!"com.spears.civilopedia".equals(clientSettings0.getRealClientPackageName())) {
            bundle0.putString("com.google.android.gms.signin.internal.realClientPackageName", clientSettings0.getRealClientPackageName());
        }
        return bundle0;
    }
    ...
    public final IInterface createServiceInterface(IBinder iBinder0) {
        ...
        return iInterface0 instanceof zaf ? ((zaf)iInterface0) : new zaf(iBinder0, "com.google.android.gms.signin.internal.ISignInService");  // 初始化器: Lcom/google/android/gms/internal/base/zaa;-><init>(Landroid/os/IBinder;Ljava/lang/String;)V
    }
    ...
    public final void zaa() {
        try {
            ((zaf)this.getService()).zae(((int)(((Integer)Preconditions.checkNotNull(this.R)))));
        }
    ...
    public final void zac(IAccountAccessor iAccountAccessor0, boolean z) {
        try {
            ((zaf)this.getService()).zaf(iAccountAccessor0, ((int)(((Integer)Preconditions.checkNotNull(this.R)))), z);
        }
        catch(RemoteException unused_ex) {
    ...
    public final void zad(com.google.android.gms.signin.internal.zae zae0) {
        ...
        try {
            Account account0 = this.P.getAccountOrDefault();
            ...
            zat zat0 = new zat(account0, ((int)(((Integer)Preconditions.checkNotNull(this.R)))), googleSignInAccount0);
