...
public final class b extends zau {
    public final Context a;
    public final GoogleApiAvailability b;

    public b(GoogleApiAvailability googleApiAvailability0, Context context0) {
    ...
    public final void handleMessage(Message message0) {
        int v = message0.what;
        if(v != 1) {
            f.p(v, "Don\'t know how to handle this message: ", "GoogleApiAvailability");
            return;
        }
