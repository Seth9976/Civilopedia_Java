...
public abstract class b {
    ...
    static {
        ...
        int v1 = a.x(0, j.z(new String[]{"Boolean", "Z", "Char", "C", "Byte", "B", "Short", "S", "Int", "I", "Float", "F", "Long", "J", "Double", "D"}).size() - 1, 2);
        if(v1 >= 0) {
        ...
        Iterator iterator0 = j.z(new String[]{"String", "CharSequence", "Throwable", "Cloneable", "Number", "Comparable", "Enum"}).iterator();
        while(iterator0.hasNext()) {
            b.a(linkedHashMap0, "Enum", "java/lang/Enum");
        }
        Iterator iterator1 = j.z(new String[]{"Iterator", "Collection", "List", "Set", "Map", "ListIterator"}).iterator();
        ...
        Iterator iterator2 = j.z(new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"}).iterator();
