...
public final class a {
    ...
    static {
        a.f = new a(0xA00000L, 604800000L, 200, 10000, 0x14000);
    }

    public a(long v, long v1, int v2, int v3, int v4) {
        this.a = v;
        this.b = v2;
        this.c = v3;
        this.d = v1;
    ...
    public final int hashCode() {
        return this.e ^ ((((((int)(this.a ^ this.a >>> 0x20)) ^ 1000003) * 1000003 ^ this.b) * 1000003 ^ this.c) * 1000003 ^ ((int)(this.d >>> 0x20 ^ this.d))) * 1000003;
    }
    ...
    public final String toString() {
        ...
        return e.g(stringBuilder0, this.e, "}");
    }
}
