...
public final class j extends SQLiteOpenHelper {
    ...
    static {
        j.k = "INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + ")";
        j.l = 5;
        j.m = Arrays.asList(new i[]{new i(0), new i(1), new i(2), new i(3), new i(4)});
    }

    public j(Context context0, int v, String s) {
    ...
    public static void a(SQLiteDatabase sQLiteDatabase0, int v, int v1) {
            ...
            while(v < v1) {
                switch(((i)list0.get(v)).a) {
                    ...
                    default: {
                        ...
                        sQLiteDatabase0.execSQL("INSERT INTO global_log_event_state VALUES (1749377822286)");
                    }
                }
                ++v;
            }
        ...
        StringBuilder stringBuilder0 = f.n("Migration from ", v, " to ", v1, " was requested, but cannot be performed. Only ");
